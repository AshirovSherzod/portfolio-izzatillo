...
export default function TiltCard({ children, className = "" }) {
    ...
    const handleMouseMove = (e) => {
        ...
        const x = e.clientX - r.left; // 0..width
        const y = e.clientY - r.top;  // 0..height
        ...
        el.style.transform =
            `perspective(${perspective}px) rotateX(${rotX}deg) rotateY(${rotY}deg) translateY(-${lift}px)`;

        // ixtiyoriy "shine" markazi uchun CSS variable
